...
sealed trait Result extends _root_.scalapb.GeneratedEnum {
  ...
  def companion: _root_.scalapb.GeneratedEnumCompanion[Result] = com.github.tozastation.clasickcoreapi.grpc.user_rpc.Result
}
...
object Result extends _root_.scalapb.GeneratedEnumCompanion[Result] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = UserRpcProto.javaDescriptor.getEnumTypes.get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = UserRpcProto.scalaDescriptor.enums(0)
  def fromJavaValue(pbJavaSource: com.github.tozastation.clasickcoreapi.grpc.Result): Result = fromValue(pbJavaSource.getNumber)
  def toJavaValue(pbScalaSource: Result): com.github.tozastation.clasickcoreapi.grpc.Result = {
    _root_.scala.Predef.require(!pbScalaSource.isUnrecognized, "Unrecognized enum values can not be converted to Java")
    com.github.tozastation.clasickcoreapi.grpc.Result.forNumber(pbScalaSource.value)
  }
}